          ...
          <div className="flex flex-wrap gap-3 mb-12 pb-12 border-b border-border">
            ...
            {project.links.github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-border bg-bg-surface rounded-lg text-sm font-semibold text-text-primary hover:border-accent hover:text-accent transition-colors"
              >
