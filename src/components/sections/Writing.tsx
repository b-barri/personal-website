          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
            {writings.map((writing) => (
              <a
                ...
                className="group block p-7 rounded-2xl border border-border bg-bg-primary dark:bg-bg-surface hover:border-accent/40 hover:shadow-lg focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg-primary outline-none transition-all duration-300"
              >
