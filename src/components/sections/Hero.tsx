...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[85vh] sm:min-h-dvh items-center justify-center overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-6 flex flex-col items-center text-center pt-16 sm:pt-0">
        <motion.div
        ...
        >
          <p className="font-[family-name:var(--font-playfair)] italic text-[11px] text-white/50 leading-snug">
            Bangalore in tabebuia bloom — the pink riot
            we call cherry blossom season.
          </p>
        </motion.div>
